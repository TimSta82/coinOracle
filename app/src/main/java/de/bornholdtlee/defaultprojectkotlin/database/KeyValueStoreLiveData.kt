...
fun SharedPreferences.intLiveData(key: String, defValue: Int) = SharedPreferenceIntLiveData(this, key, defValue)
fun SharedPreferences.stringLiveData(key: String, defValue: String) = SharedPreferenceStringLiveData(this, key, defValue)
fun SharedPreferences.booleanLiveData(key: String, defValue: Boolean) = SharedPreferenceBooleanLiveData(this, key, defValue)
fun SharedPreferences.floatLiveData(key: String, defValue: Float) = SharedPreferenceFloatLiveData(this, key, defValue)
fun SharedPreferences.longLiveData(key: String, defValue: Long) = SharedPreferenceLongLiveData(this, key, defValue)
fun SharedPreferences.stringSetLiveData(key: String, defValue: Set<String>) = SharedPreferenceStringSetLiveData(this, key, defValue)
